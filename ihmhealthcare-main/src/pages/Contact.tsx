          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-[#F8F9FA] rounded-[40px] p-8 md:p-12 border border-gray-100 shadow-sm">
              ...
              <form className="space-y-6">
                ...
                <button className="w-full py-5 bg-[#0052B4] text-white rounded-2xl font-bold text-lg hover:bg-[#004191] transition-all shadow-lg flex items-center justify-center gap-3">
